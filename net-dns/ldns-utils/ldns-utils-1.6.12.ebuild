...
# $Header: /var/cvsroot/gentoo-x86/net-dns/ldns-utils/ldns-utils-1.6.12.ebuild,v 1.5 2015/01/15 08:39:56 ago Exp $
...
src_prepare() {
	...
	# Remove ENGINE_load_cryptodev since it is not supported by libressl
	# Thanks to Voidlinux: https://github.com/voidlinux/void-packages/blob/master/srcpkgs/ldns/patches/libressl.patch
