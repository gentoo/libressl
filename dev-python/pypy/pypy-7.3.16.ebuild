...
PATCHES=(
	"${WORKDIR}/${PATCHSET}"
	"${FILESDIR}"/engine.patch
	"${FILESDIR}"/err.patch
	"${FILESDIR}"/patch-lib_pypy__cffi_ssl__cffi_src_openssl_crypto_py.patch
	"${FILESDIR}"/patch-lib_pypy__cffi_ssl__cffi_src_openssl_ct_py.patch
	"${FILESDIR}"/patch-lib_pypy__cffi_ssl__cffi_src_openssl_dh_py.patch
	"${FILESDIR}"/patch-lib_pypy__cffi_ssl__cffi_src_openssl_evp_py.patch
	"${FILESDIR}"/patch-lib_pypy__cffi_ssl__cffi_src_openssl_hmac_py.patch
	"${FILESDIR}"/patch-lib_pypy__cffi_ssl__cffi_src_openssl_ocsp_py.patch
	"${FILESDIR}"/patch-lib_pypy__cffi_ssl__cffi_src_openssl_ssl_py.patch
	"${FILESDIR}"/patch-lib_pypy__cffi_ssl__cffi_src_openssl_x509_py.patch
	"${FILESDIR}"/patch-lib_pypy__cffi_ssl__cffi_src_openssl_x509name_py.patch
	"${FILESDIR}"/ssl.patch
	"${FILESDIR}"/x509v3.patch
)
